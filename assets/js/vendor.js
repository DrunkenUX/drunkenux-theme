...
!function (e) {
  ...
  (function (t) {
    "object" == (typeof navigator === "undefined" ? "undefined" : _typeof(navigator)) && (e.exports = function () {
      ...
      function ce(e, t, n) {
        var i = document.createElement(e);
        return U(t) && le(i, t), W(n) && (i.innerText = n), i;
      }
      ...
      function de(e) {
        Q(e) || $(e) ? Array.from(e).forEach(de) : X(e) && X(e.parentNode) && e.parentNode.removeChild(e);
      }
      ...
      function pe(e, t) {
        ...
        return e.split(",").forEach(function (e) {
          ...
          switch (t.charAt(0)) {
            case ".":
              W(i.class) ? n.class = "".concat(i.class, " ").concat(a) : n.class = a;
              break;
      ...
      function _e(e) {
        return !!($(e) || W(e) && e.includes(":")) && ($(e) ? e : e.split(":")).map(Number).every(z);
      }

      function je(e) {
        if (!$(e) || !e.every(z)) return null;
      ...
      function qe(e) {
        ...
        if (null === n && (n = t(this.config.ratio)), null === n && !te(this.embed) && $(this.embed.ratio) && (n = this.embed.ratio), null === n && this.isHTML5) {
          var i = this.media;
          n = je([i.videoWidth, i.videoHeight]);
        }
      ...
      var We = {
        ...
        if (te(e) || te(t)) return "";
        var n = re(t.i18n, e);
        if (te(n)) return Object.keys(We).includes(e) ? We[e] : "";
        var i = {
          "{seektime}": t.seekTime,
          "{title}": t.title
        };
      ...
      var et = {
        ...
        createButton: function createButton(e, t) {
          ...
          return r.toggle ? (o.appendChild(et.createIcon.call(this, r.iconPressed, {
            ...
            class: "label--not-pressed"
          }))) : (o.appendChild(et.createIcon.call(this, r.icon)), o.appendChild(et.createLabel.call(this, r.label))), oe(i, pe(this.config.selectors.buttons[a], i)), le(o, i), "play" === a ? ($(this.elements.buttons[a]) || (this.elements.buttons[a] = []), this.elements.buttons[a].push(o)) : this.elements.buttons[a] = o, o;
        },
        createRange: function createRange(e, t) {
        ...
        updateTimeDisplay: function updateTimeDisplay() {
          var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : null,
              t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : 0,
              n = arguments.length > 2 && void 0 !== arguments[2] && arguments[2];
          X(e) && z(t) && (e.innerText = et.formatTime(t, n));
        },
        updateVolume: function updateVolume() {
        ...
        setQualityMenu: function setQualityMenu(e) {
          ...
          if (X(this.elements.settings.panels.quality)) {
            var n = "quality",
                i = this.elements.settings.panels.quality.querySelector('[role="menu"]');
            $(e) && (this.options.quality = He(e).filter(function (e) {
              return t.config.quality.options.includes(e);
            }));
            var a = !te(this.options.quality) && this.options.quality.length > 1;
        ...
        create: function create(e) {
          ...
          return He($(this.config.controls) ? this.config.controls : []).forEach(function (s) {
            if ("restart" === s && u.appendChild(i.call(t, "restart", d)), "rewind" === s && u.appendChild(i.call(t, "rewind", d)), "play" === s && u.appendChild(i.call(t, "play", d)), "fast-forward" === s && u.appendChild(i.call(t, "fast-forward", d)), "progress" === s) {
              var l = ce("div", {
                class: "".concat(d.class, " plyr__progress__container")
              }),
        ...
        inject: function inject() {
          ...
          if (Y(this.config.controls) && (this.config.controls = this.config.controls.call(this, r)), this.config.controls || (this.config.controls = []), X(this.config.controls) || W(this.config.controls) ? n = this.config.controls : (n = et.create.call(this, {
            id: this.id,
            seektime: this.config.seekTime,
            speed: this.speed,
            quality: this.quality,
            captions: it.getLabel.call(this)
          }), o = !1), o && W(this.config.controls) && (i = n, Object.entries(r).forEach(function (e) {
            var t = l(e, 2),
                n = t[0],
                a = t[1];
            i = Ve(i, "{".concat(n, "}"), a);
          }), n = i), W(this.config.selectors.controls.container) && (a = document.querySelector(this.config.selectors.controls.container)), X(a) || (a = this.elements.container), a[X(n) ? "insertAdjacentElement" : "insertAdjacentHTML"]("afterbegin", n), X(this.elements.controls) || et.findElements.call(this), !te(this.elements.buttons)) {
            var s = function s(t) {
              var n = e.config.classNames.controlPressed;
              Object.defineProperty(t, "pressed", {
                enumerable: !0,
            ...
            Object.values(this.elements.buttons).filter(Boolean).forEach(function (e) {
              $(e) || Q(e) ? Array.from(e).filter(Boolean).forEach(s) : s(e);
            });
          }
      ...
      var it = {
        setup: function setup() {
          if (this.supported.ui) if (!this.isVideo || this.isYouTube || this.isHTML5 && !Ae.textTracks) $(this.config.controls) && this.config.controls.includes("settings") && this.config.settings.includes("captions") && et.setCaptionsMenu.call(this);else {
            if (X(this.elements.captions) || (this.elements.captions = ce("div", pe(this.config.selectors.captions)), function (e, t) {
              ...
              Array.from(e).forEach(function (e) {
                var t = e.getAttribute("src"),
                    n = tt(t);
                null !== n && n.hostname !== window.location.href.hostname && ["http:", "https:"].includes(n.protocol) && $e(t, "blob").then(function (t) {
                  e.setAttribute("src", window.URL.createObjectURL(t));
                }).catch(function () {
                  de(e);
                });
        ...
        update: function update() {
          ...
          }), (s && this.language !== a || !t.includes(o)) && (it.setLanguage.call(this, a), it.toggle.call(this, i && s)), ge(this.elements.container, this.config.classNames.captions.enabled, !te(t)), $(this.config.controls) && this.config.controls.includes("settings") && this.config.settings.includes("captions") && et.setCaptionsMenu.call(this);
        },
        toggle: function toggle(e) {
          var t = this,
              n = !(arguments.length > 1 && void 0 !== arguments[1]) || arguments[1];
      ...
      var dt = {
        ...
        setTitle: function setTitle() {
          ...
          if (W(this.config.title) && !te(this.config.title) && (e += ", ".concat(this.config.title)), Array.from(this.elements.buttons.play || []).forEach(function (t) {
            t.setAttribute("aria-label", e);
          }), this.isEmbed) {
            var t = we.call(this, "iframe");
            if (!X(t)) return;
        ...
        migrateStyles: function migrateStyles() {
          var e = this;
          Object.values(s({}, this.media.style)).filter(function (e) {
            return !te(e) && W(e) && e.startsWith("--plyr");
          }).forEach(function (t) {
            e.elements.container.style.setProperty(t, e.media.style.getPropertyValue(t)), e.media.style.removeProperty(t);
          }), te(this.media.style) && this.media.removeAttribute("style");
        }
        ...
        return a(e, [{
          ...
          value: function value(e) {
            var t = this.player,
                ...
                a = "keydown" === e.type,
                r = a && i === this.lastKey;
            if (!(e.altKey || e.ctrlKey || e.metaKey || e.shiftKey) && z(i)) if (a) {
              var o = document.activeElement;
      ...
      var gt = {
        ...
        ready: function ready() {
          ...
          te(c) && (c = t.media.getAttribute(t.config.attributes.embed.id));
          var u,
              d = te(u = c) ? null : z(Number(u)) ? u : u.match(/^.*(vimeo.com\/|video\/)(\d+).*/) ? RegExp.$2 : u,
              h = ce("iframe"),
          ...
          n.customControls || $e(Re(t.config.urls.vimeo.api, m)).then(function (e) {
            !te(e) && e.thumbnail_url && dt.setPoster.call(t, e.thumbnail_url).catch(function () {});
          }), t.embed = new window.Vimeo.Player(h, {
            autopause: t.config.autopause,
            muted: t.muted
      ...
      var vt,
        ...
        getTitle: function getTitle(e) {
          var t = this;
          $e(Re(this.config.urls.youtube.api, e)).then(function (e) {
            if (U(e)) {
              var n = e.title,
                  i = e.height,
                  a = e.width;
        ...
        function e(t) {
          ...
          n(this, e), r(this, "load", function () {
            ...
            return $(i.events[e]) || (i.events[e] = []), i.events[e].push(t), i;
          }), r(this, "startSafetyTimer", function (e, t) {
            i.player.debug.log("Safety timer invoked from: ".concat(t)), i.safetyTimer = setTimeout(function () {
              i.cancel(), i.clearSafetyTimer("startSafetyTimer()");
            }, e);
        ...
        function e(t, i) {
          ...
          if (n(this, e), r(this, "play", function () {
            ...
            a.currentTime -= z(e) ? e : a.config.seekTime;
          }), r(this, "forward", function (e) {
            a.currentTime += z(e) ? e : a.config.seekTime;
          }), r(this, "increaseVolume", function (e) {
            var t = a.media.muted ? 0 : a.volume;
            ...
            if (a.supported.ui && !a.isAudio) {
              ...
              if (i && $(a.config.controls) && a.config.controls.includes("settings") && !te(a.config.settings) && et.toggleMenu.call(a, !1), i !== t) {
                var r = i ? "controlshidden" : "controlsshown";
                Ne.call(a, a.media, r);
              }
            ...
            return Ae.mime.call(a, e);
          }), this.timers = {}, this.ready = !1, this.loading = !1, this.failed = !1, this.touch = Ae.touch, this.media = t, W(this.media) && (this.media = document.querySelectorAll(this.media)), (window.jQuery && this.media instanceof jQuery || Q(this.media) || $(this.media)) && (this.media = this.media[0]), this.config = oe({}, at, e.defaults, i || {}, function () {
            try {
              return JSON.parse(a.media.getAttribute("data-plyr-config"));
            } catch (e) {
              return {};
        ...
        return a(e, [{
          ...
          set: function set(e) {
            var t = e;
            W(t) && (t = Number(t)), z(t) || (t = this.storage.get("volume")), z(t) || (t = this.config.volume), t > 1 && (t = 1), t < 0 && (t = 0), this.config.volume = t, this.media.volume = t, !te(e) && this.muted && t > 0 && (this.muted = !1);
          },
          get: function get() {
            return Number(this.media.volume);
          }
          ...
          set: function set(e) {
            ...
            if (n.length) {
              var i = [!te(e) && Number(e), this.storage.get("quality"), t.selected, t.default].find(z),
                  a = !0;
          ...
          set: function set(e) {
            this.isVideo ? W(e) && _e(e) ? (this.config.ratio = e, De.call(this)) : this.debug.error("Invalid aspect ratio specified (".concat(e, ")")) : this.debug.warn("Aspect ratio can only be set for video");
          }
        }, {
          key: "autoplay",
          set: function set(e) {
          ...
          value: function value(t) {
            var n = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {},
                i = null;
            return W(t) ? i = Array.from(document.querySelectorAll(t)) : Q(t) ? i = Array.from(t) : $(t) && (i = t.filter(X)), te(i) ? null : i.map(function (t) {
              return new e(t, n);
            });
          }
        }]), e;
  ...
  n.r(t), n.d(t, "typeturaInit", function () {
    return r;
  }), n.d(t, "typeturize", function () {
    return i;
  });
          ...
          if (Array.isArray(e) && e.length) {
            ...
            try {
              for (_iterator.s(); !(_step = _iterator.n()).done;) {
                var _t = _step.value;
                _t.contentRect && _t.target.style.setProperty("--tt-bind", _t.contentRect.width);
              }
            } catch (err) {
              _iterator.e(err);
            } finally {
  ...
  var a = function a(_ref) {
    ...
    return n.innerHTML = "html{--tt-base: ".concat(e, ";--tt-scale: ").concat(t, ";--tt-ease:linear;--tt-max:1600}*,:before,:after,html{--tt-key:none;animation:var(--tt-key) 1s var(--tt-ease) 1 calc(-1s * var(--tt-bind) / var(--tt-max)) both paused}"), n;
  };

  var r = function r() {
    var e = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
    var t = e.selectors || [".typetura"],
        n = e.base || 20,
        r = e.scale || 1;
    return new Promise(function (e, o) {
      ...
      i(document.documentElement), document.head.insertBefore(s, document.head.firstChild), e();
    });
  };
}]);
"use strict";
